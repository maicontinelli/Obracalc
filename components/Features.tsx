            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 max-w-6xl mx-auto">
                    ...
                    <div className="md:col-span-12 group">
                        <SpotlightCard className="h-full overflow-hidden p-0 flex flex-col md:flex-row items-stretch">
                            ...
                            <div className="flex-[1.4] relative min-h-[300px] md:min-h-[450px] bg-neutral-100/30 dark:bg-background/40 flex items-center justify-center p-6 md:p-12">
                                {/* Dashboard Mockup Window */}
                                <div
                                    className="relative w-full aspect-video md:h-full shadow-2xl rounded-xl overflow-hidden bg-white cursor-zoom-in group/mockup"
                                    onClick={() => setPreviewImage("/cronograma.webp")}
                                >
                                    <div className="absolute top-0 left-0 right-0 h-6 bg-neutral-100 border-b border-neutral-200/50 flex items-center px-3 gap-1.5 z-10">
                    ...
                    <div className="md:col-span-12 group">
                        <SpotlightCard className="h-full overflow-hidden p-0 flex flex-col md:flex-row-reverse items-stretch">
                            <div className="p-6 md:p-8 flex-1 flex flex-col justify-center">
                                <div className="flex items-center gap-4 mb-4">
                    ...
                    <div className="md:col-span-12 group">
                        <SpotlightCard className="h-full overflow-hidden p-0 flex flex-col md:flex-row items-stretch">
                            ...
                            <div className="flex-[1.4] relative min-h-[300px] md:min-h-[450px] bg-neutral-100/30 dark:bg-background/40 flex items-center justify-center p-6 md:p-12">
                                ...
                                <div
                                    className="relative w-full aspect-[4/3] md:h-full shadow-2xl rounded-xl overflow-hidden bg-white cursor-zoom-in group/mockup"
                    ...
                    <div className="md:col-span-12">
                        <SpotlightCard
                            className="h-full p-8 md:p-16 flex flex-col md:flex-row items-center justify-between bg-gradient-to-br from-[#74D2E7]/10 to-transparent border-[#74D2E7]/30 ring-1 ring-[#74D2E7]/20 text-center md:text-left rounded-3xl overflow-hidden"
                            spotlightColor="rgba(116, 210, 231, 0.1)"
                        >
                            <div className="flex-1 space-y-6">
                                <h3 className="text-2xl md:text-3xl font-bold text-foreground font-heading leading-tight max-w-3xl">
                                    Porque usuários <span className="text-[#74D2E7]">Pró</span> estão faturando até +20% com Obra Plana?
                                </h3>
                                ...
                                <ul className="space-y-3 text-muted-foreground text-sm md:text-base text-left list-none pl-0">
                                    {[
                                        ...
                                        "Acesso exclusivo a recursos de automatização"
                                    ].map((bullet, i) => (
                                        <li key={i} className="flex items-start gap-3">
                                            <div className="mt-0.5 w-6 h-6 shrink-0 relative">
                                                <NextImage
                                ...
                                <div className="flex items-center justify-center md:justify-start gap-4 pt-4">
                                    <Link href="/planos#profissional" className="group flex items-center gap-3 font-bold text-[#74D2E7] hover:gap-6 transition-all uppercase tracking-[0.2em] text-sm md:text-base border-b-2 border-transparent hover:border-[#74D2E7] pb-1">
                                        <span>Quero conhecer o plano!</span>
                                        <ArrowRight className="w-5 h-5" />
                                    </Link>
                                </div>
                            </div>

                            <div className="hidden md:flex ml-12 flex-shrink-0 relative">
                                <NextImage
                                    src="/mascot-running.png"
                                    alt="ObraPlana Mascot"
                                    width={160}
                                    height={160}
